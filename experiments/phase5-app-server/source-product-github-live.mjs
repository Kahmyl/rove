...
const artifactPath = join(
  root,
  "artifacts/phase5-github-live-20260909-181822.json",
);
const nativeScreenshotPath = join(
  root,
  "docs/experiments/artifacts/p5.9-live-acceptance/github-20260909-181822-native.png",
);
const priorCampaignPath = join(
  root,
  "artifacts/phase5-source-product-stabilization.json",
);
...
const outcome = `Create a new private GitHub repository named rove-phase5-live-20260909-181822.
...
function finalEvidence(task) {
  ...
  return {
    ...
    repositoryUrls: [
      ...new Set(
        combined.match(
          /https:\/\/github\.com\/[A-Za-z0-9_.-]+\/rove-phase5-live-20260909-0415(?:\/issues\/1)?/g,
        ) ?? [],
      ),
    ],
