...
const fixturePath = new URL(
  "./fixtures/lifecycle-contract.json",
  import.meta.url,
);
const evidencePath = new URL(
  "../../artifacts/verification/lifecycle-contract/results.json",
  import.meta.url,
);
...
const evidence = {
  ...
  fixture: "experiments/agent-execution/fixtures/lifecycle-contract.json",
