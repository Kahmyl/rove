...
describe("P5.1 generated boundary", () => {
...
describe("P5.3 bounded conversation projection", () => {
...
describe("P5.4 capability and bootstrap", () => {
...
describe("P5.5 trusted attention and continuation", () => {
