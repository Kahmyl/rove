...
Action Outputs distinguish Ready for approval, Approved, Checking outcome, Sent/Completed, Couldn't complete, and Outcome unclear while preserving the internal prepared, authorized, dispatched, confirmed, failed, and unresolved states. The customer reviews exact consequence and material; browser-control grounding stays internal. An uncertain send warns against blind repetition of that send, not all future conversation. The user can ask an unrelated question at any point.
