...
import type {
  Gate6SemanticSurfaceV4,
  Gate6SurfaceFactsV4,
} from "./surface-ownership-semantics.js";

type Truth = true | false | "indeterminate";

export interface Gate6CandidateV4Input extends Gate5Input {
  surfaceFacts?: Gate6SurfaceFactsV4;
}
...
function surfaceEligibleForKnownBlocker(
  surface: Gate6SemanticSurfaceV4,
...
export function gate6CandidateV4Strategy(): BenchmarkStrategy<Gate6CandidateV4Input> {
  return {
    name: "gate6-s4r4-surface-ownership",
    predict(input) {
