...
export type Gate6SurfaceKindV4 =
  "primary" | "blocking_dialog" | "alert" | "supplementary";

export interface Gate6SemanticSurfaceV4 {
  id: string;
  kind: Gate6SurfaceKindV4;
  blocking: boolean;
...
export interface Gate6SurfaceFactsV4 {
  available: boolean;
  ...
  surfaces: Gate6SemanticSurfaceV4[];
...
export async function collectGate6SurfaceFactsV4(
  page: Page,
): Promise<Gate6SurfaceFactsV4> {
  return page.evaluate<Gate6SurfaceFactsV4>(`(() => {
