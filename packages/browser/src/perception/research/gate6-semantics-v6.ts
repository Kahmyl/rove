...
export type Gate6SurfaceKindV6 =
  "primary" | "blocking_dialog" | "alert" | "supplementary";

export interface Gate6SemanticSurfaceV6 {
  id: string;
  kind: Gate6SurfaceKindV6;
  blocking: boolean;
...
export interface Gate6SurfaceFactsV6 {
  available: boolean;
  ...
  surfaces: Gate6SemanticSurfaceV6[];
...
export async function collectGate6SurfaceFactsV6(
  page: Page,
): Promise<Gate6SurfaceFactsV6> {
  return page.evaluate<Gate6SurfaceFactsV6>(`(() => {
