...
export type Gate6SurfaceKindV7 =
  "primary" | "blocking_dialog" | "alert" | "supplementary";

export interface Gate6SemanticSurfaceV7 {
  id: string;
  kind: Gate6SurfaceKindV7;
  blocking: boolean;
...
export interface Gate6SurfaceFactsV7 {
  available: boolean;
  ...
  surfaces: Gate6SemanticSurfaceV7[];
...
export async function collectGate6SurfaceFactsV7(
  page: Page,
): Promise<Gate6SurfaceFactsV7> {
  return page.evaluate<Gate6SurfaceFactsV7>(`(() => {
